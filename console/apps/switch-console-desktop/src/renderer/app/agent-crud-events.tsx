 ...
 * agents store AND location manager, and refetch any open "Load existing
 * agents" discovery, so a created or removed agent is reflected everywhere
 * without per-call-site invalidation.
 */
  ...
  useEffect(
    () =>
      events.on(agentsChangedChannel, () => {
        ...
        void getLocationManagerStore().reload();
