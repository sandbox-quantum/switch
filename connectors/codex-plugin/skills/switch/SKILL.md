---
name: "switch"
description: "How to participate in a Switch room — connecting, posting, threads, events, tasks and roles. Read this once when Switch work starts (the user mentions Switch, a Switch room, or another Switch agent; or a `[Switch]` event arrives). It stays in effect for the rest of the session — do not re-read it before each tool call."
---
