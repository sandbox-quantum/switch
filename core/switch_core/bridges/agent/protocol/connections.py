...
# Minimum interval between reattaches on the same connection.
...
class ReattachTooSoonError(ConnectionError_):
    """A reattach arrived before the minimum interval elapsed."""
...
class Connection:
    ...
    # reattach that arrives too soon.
    ...
    def open(
        ...
        *,
        ...
        if existing is not None:
            ...
            # Two supervisors on one connection id would otherwise evict each
            # other at about nine reattaches a second.
            now = time.monotonic()
