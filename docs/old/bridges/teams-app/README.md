...
**Do not edit this file to put your app id in it.** It is tracked in a public
repository; pass `--app-id` to the builder below and it fills all three places
without touching the file. The table is here for the by-hand path.
